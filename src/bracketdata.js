...
//Not in this year's tournament
export const AbelineChristian = 99;
export const ArizonaState = 99;
export const BoiseState = 99;
export const Charleston = 99;
export const ClevelandState = 99;
export const Colgate = 99;
export const Colorado = 99;
export const Dayton = 99;
export const Duquesne = 99;
export const Drexel = 99;
export const EasternWashington = 99;
export const FloridaAtlantic = 99;
export const FloridaState = 99;
export const Furman = 99;
export const Georgetown = 99;
export const GeorgiaTech = 99;
export const Hartford = 99;
export const Indiana = 99;
export const Iona = 99;
export const Iowa = 99;
export const JamesMadison = 99;
export const KansasState = 99;
export const KennesawState = 99;
export const KentState = 99;
export const Louisiana = 99;
export const LongBeachState = 99;
export const LoyolaChicago = 99;
export const LSU = 99;
export const Miami = 99;
export const MontanaState = 99;
export const MoreheadState = 99;
export const NCState = 99;
export const Nebraska = 99;
export const Nevada = 99;
export const NorthTexas = 99;
export const Northwestern = 99;
export const Oakland = 99;
export const Ohio = 99;
export const OhioSt = 99;
export const OklahomaState = 99;
export const OralRoberts = 99;
export const OregonState = 99;
export const PennState = 99;
export const Pittsburgh = 99;
export const Providence = 99;
export const Rutgers = 99;
export const SaintPeters = 99;
export const Samford = 99;
export const SanDiegoState = 99;
export const SouthCarolina = 99;
export const StBonaventure = 99;
export const Syracuse = 99;
export const TCU = 99;
export const Texas = 99;
export const TexasSouthern = 99;
export const UAB = 99;
export const UCSantaBarbara = 99;
export const UNCAsheville = 99;
export const UNCGreensboro = 99;
export const USC = 99;
export const Vermont = 99;
export const Villanova = 99;
export const Virginia = 99;
export const VirginiaTech = 99;
export const WashingtonState = 99;
export const WestVirginia = 99;
export const Winthrop = 99;
